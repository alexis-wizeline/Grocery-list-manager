...
an app to create derivated lists from a master list to do groceries, it will also create the list from a provided menu for the week
...
- Rails
- Mongo DB
- Hotwire (trying to use other technologies than react)
...
## afetr we handle the initial work
- how do we imporve the code quality ?
